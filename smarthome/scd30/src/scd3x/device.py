...
class Scd3xI2cDevice(I2cDevice):
    ...
    def read_serial_number(self):
        ...
        :rtype: int
        """
        return self.execute(Scd3XI2CCmdGetSerialNumber())

    def start_periodic_measurement(self, power_mode=Scd3xPowerMode.HIGH):
        """
        ...
        """
        if power_mode == Scd3xPowerMode.HIGH:
            result = self.execute(Scd3XI2CCmdStartPeriodicMeasurement())
        elif power_mode == Scd3xPowerMode.LOW:
            result = self.execute(Scd3XI2CCmdStartLowPowerPeriodicMeasurement())
        else:
    ...
    def get_sensor_altitude(self):
        ...
        .. note:: Only available in idle mode.
        """
        return self.execute(Scd3XI2CCmdGetSensorAltitude())
    ...
    def set_sensor_altitude(self, sensor_altitude):
        ...
        .. note:: Only available in idle mode.
        """
        return self.execute(Scd3XI2CCmdSetSensorAltitude(sensor_altitude))
    ...
    def set_ambient_pressure(self, ambient_pressure):
        ...
        """
        return self.execute(Scd3XI2CCmdSetAmbientPressure(ambient_pressure))
    ...
    def perform_forced_recalibration(self, target_co2_concentration):
        ...
        :rtype: int
        """
        return self.execute(Scd3XI2CCmdPerformForcedRecalibration(target_co2_concentration))
    ...
    def get_automatic_self_calibration(self):
        ...
        :rtype: int
        """
        ret = self.execute(Scd3XI2CCmdGetAutomaticSelfCalibration())
        return ret == 1
    ...
    def persist_settings(self):
        ...
        """
        return self.execute(Scd3XI2CCmdPersistSettings())
    ...
    def perform_self_test(self):
        ...
        :rtype: int
        """
        return self.execute(Scd3XI2CCmdPerformSelfTest())
    ...
    def perform_factory_reset(self):
        ...
        .. note:: To avoid unnecessary wear of the EEPROM, this command should only
                  ...
                  a separate EEPROM dimensioned for specified sensor lifetime.
        """
        return self.execute(Scd3XI2CCmdPerformFactoryReset())
    ...
    def measure_single_shot(self):
        ...
        .. note:: Only available in idle mode.
        """
        return self.execute(Scd3XI2CCmdMeasureSingleShot())
    ...
    def measure_single_shot_rht_only(self):
        ...
        .. note:: Only available in idle mode.
        """
        return self.execute(Scd3XI2CCmdMeasureSingleShotRhtOnly())
    ...
    def power_down(self):
        ...
        .. note:: Only available in idle mode.
        """
        return self.execute(Scd3XI2CCmdPowerDown())
    ...
    def wake_up(self):
        ...
        """
        try:
            self.execute(Scd3XI2CCmdWakeUp())
        except I2cNackError:
